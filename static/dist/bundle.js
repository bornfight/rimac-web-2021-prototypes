...
var HomeVerticalSliderLooped = /*#__PURE__*/function () {
  function HomeVerticalSliderLooped() {
    _classCallCheck(this, HomeVerticalSliderLooped);
  ...
  _createClass(HomeVerticalSliderLooped, [{
    key: "init",
    value: function init() {
      var _this = this;
    ...
    value: function initSlider() {
      ...
      this.swiper = new _swiper.default(this.slider, {
        ...
        on: {
          progress: function progress() {
            var swiper = this;
            var currentProgress = swiper.progress; // self.progressCircle(swiper, currentProgress);
          },
          init: function init() {
            _this4.zoomIn();
          ...
          slideNextTransitionStart: function slideNextTransitionStart() {
            ...
            if (counter !== 0) {
              _this4.zoomOut(fullCircleOffset, false);
            }
          ...
          slidePrevTransitionStart: function slidePrevTransitionStart() {
            ...
            if (counter !== 0) {
              _this4.zoomOut(fullCircleOffset, true);
            }
    ...
    key: "progressController",
    value: function progressController(fullCircleOffset, direction) {
      var offset = "";
    ...
    key: "zoomOut",
    value: function zoomOut(fullCircleOffset, direction) {
      var _this5 = this;
      ...
      _gsap.gsap.to(this.camera.position, {
        ...
        onComplete: function onComplete() {
          ...
          _this5.progressController(fullCircleOffset, direction);
        }
      });
  ...
  return HomeVerticalSliderLooped;
}();

exports.default = HomeVerticalSliderLooped;

},{"gsap":"gsap","swiper":"swiper","three":"three","three/examples/jsm/controls/OrbitControls":"three/examples/jsm/controls/OrbitControls","three/examples/jsm/libs/dat.gui.module.js":"three/examples/jsm/libs/dat.gui.module.js","three/examples/jsm/postprocessing/BokehPass":"three/examples/jsm/postprocessing/BokehPass","three/examples/jsm/postprocessing/EffectComposer":"three/examples/jsm/postprocessing/EffectComposer","three/examples/jsm/postprocessing/RenderPass":"three/examples/jsm/postprocessing/RenderPass"}],5:[function(require,module,exports){
"use strict";
...
},{"gsap":"gsap","three":"three","three/examples/jsm/libs/dat.gui.module.js":"three/examples/jsm/libs/dat.gui.module.js"}],7:[function(require,module,exports){
"use strict";
...
},{"gsap":"gsap","swiper":"swiper","three":"three","three/examples/jsm/libs/dat.gui.module.js":"three/examples/jsm/libs/dat.gui.module.js","three/examples/jsm/postprocessing/BokehPass":"three/examples/jsm/postprocessing/BokehPass","three/examples/jsm/postprocessing/EffectComposer":"three/examples/jsm/postprocessing/EffectComposer","three/examples/jsm/postprocessing/RenderPass":"three/examples/jsm/postprocessing/RenderPass"}],9:[function(require,module,exports){
"use strict";
...
var _HomeVerticalSliderLooped = _interopRequireDefault(require("./components/HomeVerticalSliderLooped"));
...
ready(function () {
  ...
  var homeVerticalSliderLooped = new _HomeVerticalSliderLooped.default();
...
},{"./components/Dummy":1,"./components/GradientBg":2,"./components/HomeVerticalSlider":3,"./components/HomeVerticalSliderLooped":4,"./components/NavigationController":5,"./components/PerlinGradient":6,"./components/ScrollProgress":7,"./components/TimelineSlider":8,"./components/VideoScrub":9,"./helpers/DarkModeHelper":10,"./helpers/EqualHeight":11,"./helpers/GridHelper":12}]},{},[13])
